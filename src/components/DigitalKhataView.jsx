        ...
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-emerald-100">
            ...
            <header className="pt-16 pb-24 px-6 md:px-12 max-w-7xl mx-auto text-center relative overflow-hidden">
                ...
                <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-slate-900 mb-6 relative z-10">
                    Trusted <span className="text-emerald-600">Digital Khata</span> for Modern Shops.
                </h1>
                ...
                <p className="text-2xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed font-light">
                    Move your shop's ledger to the cloud. Never lose a record again.
                    <br />
                    <span className="text-base text-slate-500">Built for Mobile Shops, Retailers, and Service Centers.</span>
                </p>
            ...
            <section className="py-16 bg-slate-50">
                <div className="max-w-4xl mx-auto px-6">
                    <h2 className="text-3xl font-bold text-center text-slate-900 mb-8">Is your physical ledger safe?</h2>
                    <div className="prose prose-lg mx-auto text-slate-600">
                        <p>
                            Physical notebooks (Khata books) are risky. They can be lost, stolen, or damaged by water/fire.
                            If you lose your book, you lose your money.
                        </p>
                        <ul className="list-disc pl-6 space-y-2 mb-8">
                            <li><strong>Cloud Backup:</strong> Your data is saved online. Even if you lose your phone, your data is safe.</li>
                            <li><strong>Search:</strong> Find any customer or transaction instantly by name.</li>
                            <li><strong>Professional:</strong> Show customers you are a modern, trustworthy business.</li>
                        </ul>
                    </div>
                </div>
            </section>
...
export default DigitalKhataView;
