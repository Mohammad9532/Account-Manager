...
const TransactionForm = ({
    ...
    const handleSubmit = async (e) => {
        ...
        if (
            ledgerAccountId &&
            payload.accountId &&
            String(payload.accountId) !== String(ledgerAccountId)
        ) {
            payload.linkedAccountId = ledgerAccountId;
            const selectedAccount = accounts.find(
                (a) => String(a._id) === String(payload.accountId),
            );
            const contextAccount = accounts.find(
                (a) => String(a._id) === String(ledgerAccountId),
            );
