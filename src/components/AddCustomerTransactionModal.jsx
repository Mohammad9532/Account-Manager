...
const AddCustomerTransactionModal = ({
    isOpen,
    onClose,
    customer,
    onTransactionAdded,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const txn = {
                ...
                description:
                    description ||
                    (type === "receipt" ? "Payment Received" : "Payment Made"),
            };

            const response = await fetch(
                `/api/currency-customers/${customer._id}`,
                {
                    method: "PUT",
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <span
                                className={`absolute left-4 top-3 font-bold ${type === "receipt" ? "text-emerald-500" : "text-rose-500"}`}
                            >
                                AED
                            </span>
                            <input
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            placeholder={
                                type === "receipt"
                                    ? "e.g. Received via Bank Transfer"
                                    : "e.g. Correction or Refund"
                            }
                        />
                    </div>
