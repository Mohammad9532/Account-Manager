    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-emerald-100">
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="prose prose-lg mx-auto text-slate-600">
                        <p>
                            ...
                            <strong>MintAccounts</strong> makes tracking receivables (Udhar) and payables (Jama) easy.
                        </p>
            ...
            <footer className="py-8 text-center text-slate-500 bg-slate-50 border-t border-slate-200">
                <p>&copy; {new Date().getFullYear()} MintAccounts. Track Receivables & Payables.</p>
            </footer>
